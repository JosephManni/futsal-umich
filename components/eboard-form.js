...
export default function EboardForm() {
    ...
    <section id="join" className="p-8 bg-gradient-to-b from-maize to-darkblue flex flex-col md:flex-col items-center justify-center w-full h-full">
      <div className="flex justify-center px-2 w-full mx-2 md:mx-10">
        <div className="flex flex-col">
          <h1 className="text-xl md:text-2xl lg:text-3xl text-darkblue font-bold uppercase mt-2 text-center p-8">Apply to EBoard</h1>
          <p className="text-black mb-4 md:text-left text-sm">{"Thanks for your interest in helping our club! Please fill out the form below and we will get back to you as soon as possible. Thanks!"}</p>
          ...
          <form className="text-white" onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label className="block text-white font-bold mb-2" htmlFor="notes">What position would you like to apply for? (or suggest one)</label>
              <textarea
                id="notes"
                name="notes"

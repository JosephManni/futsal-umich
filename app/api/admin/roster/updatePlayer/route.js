...
const createRequestBody = (body) => {
    ...
    if (body.position || body.year || body.waiver !== undefined || body.preferred_style || body.preferred_date || body.signup_done !== undefined || body.assigned_date || body.signup_time || body.umid || body.dob) {
        ...
        if (body.umid) requestBody.user_metadata.umid = body.umid;
        if (body.dob) requestBody.user_metadata.dob = body.dob;
    }

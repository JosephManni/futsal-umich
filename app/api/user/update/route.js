...
const createRequestBody = (body) => {
    ...
    if (body.position || body.year || body.waiver !== undefined || body.preferred_style || body.preferred_date || body.signup_done !== undefined || body.signup_time || body.umid || body.dob) {
